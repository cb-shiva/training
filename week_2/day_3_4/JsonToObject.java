...
public class JsonToObject{
    ...
    JsonToObject(String inputFileName){
    ...
    public TeacherStudent getObject() throws IOException,ParseException{
    ...
    public static void main(String[] args) throws IOException,ParseException{
        JsonToObject jo = new JsonToObject(args[0]);
        TeacherStudent ts = jo.getObject();
    }
}